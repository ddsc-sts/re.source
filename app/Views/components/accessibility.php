...
<section class="a11y-panel" id="a11yPanel" role="dialog" aria-labelledby="a11yTitle" hidden>
  ...
  <div class="a11y-group">
    <label for="a11yLanguage" data-i18n="site_language">Idioma do site</label>
  ...
  <div class="a11y-group">
    ...
    <div class="a11y-actions"><button type="button" data-font="normal" aria-label="Texto padrão">A</button><button type="button" data-font="large" aria-label="Texto grande">A+</button><button type="button" data-font="larger" aria-label="Texto maior">A++</button></div>
  </div>
  <div class="a11y-group">
...
<script src="<?= htmlspecialchars(asset_url('/js/accessibility.js?v=2.3'), ENT_QUOTES, 'UTF-8') ?>" defer></script>
