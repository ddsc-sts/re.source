...
if (!$id) {
    header("Location: /RE.SOURCE/base.php");
    exit;
}
...
<div class="bloco-info">
    ...
    <div class="carrosel-topo">
        ...
        <a href="/RE.SOURCE/busca.php?empresa=<?= $anuncio['company_id'] ?>" class="link-ver-todos">Ver todos os anúncios <i data-lucide="chevron-right" style="width: 16px; height: 16px; vertical-align: middle;"></i></a>
    </div>
    <div class="grid-cards">
        <?php foreach($sellerAds as $ad): ?>
            <a href="/RE.SOURCE/anuncio.php?id=<?= $ad['id'] ?>" class="mini-card">
